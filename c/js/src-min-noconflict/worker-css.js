...
(function(e) {
    ...
    }, e.console.error = e.console.warn = e.console.log = e.console.trace = e.console, e.window = e, e.ace = e, e.normalizeModule = function(e, t) {
        if (t.indexOf("!") !== -1) {
            var n = t.split("!");
...
})(this), ace.define("ace/lib/event_emitter", ["require", "exports", "module"], function(e, t, n) {
    var r = {},
        i = function() {
    ...
    function() {
        ...
        Pseudos.ELEMENT = 1, Pseudos.CLASS = 2, Pseudos.isElement = function(e) {
            ...
            function t(e) {
                var n, r, i, a, f = e.elementName ? e.elementName.text : "",
                    l;
    ...
    var CSSLint = function() {
        ...
        return i.version = "0.9.10", i.addRule = function(e) {
            ...
            var s = 0,
                o = t.length,
                u, a, f, l = new parserlib.css.Parser({
                    starHack: !0,
                    ieFilters: !0,
                    underscoreHack: !0,
                    strict: !1
    ...
    Reporter.prototype = {
            ...
            init: function(e, t) {
                ...
                function r() {
                    ...
                    if (!a) {
                        if (u.height)
                            for (e in o) o.hasOwnProperty(e) && u[e] && (n = u[e].value, (e != "padding" || n.parts.length !== 2 || n.parts[0].value !== 0) && t.report("Using height with " + e + " can sometimes make elements larger than you expect.", u[e].line, u[e].col, i));
                        if (u.width)
                            for (e in s) s.hasOwnProperty(e) && u[e] && (n = u[e].value, (e != "padding" || n.parts.length !== 2 || n.parts[1].value !== 0) && t.report("Using width with " + e + " can sometimes make elements larger than you expect.", u[e].line, u[e].col, i))
                    }
                }
                var i = this,
                    s = {
            ...
            init: function(e, t) {
                ...
                e.addListener("startrule", function() {
                    ...
                    for (o = 0, u = i.length; o < u; o++) {
                        a = i[o];
                        for (f in r) r.hasOwnProperty(f) && (l = r[f], CSSLint.Util.indexOf(l, a.text) > -1 && (s[f] || (s[f] = {
                            full: l.slice(0),
                            actual: [],
                            actualNodes: []
                    ...
                    for (f in s)
                        if (s.hasOwnProperty(f)) {
                            ...
                            if (h.length > p.length)
                                for (o = 0, u = h.length; o < u; o++) d = h[o], CSSLint.Util.indexOf(p, d) === -1 && (v = p.length === 1 ? p[0] : p.length == 2 ? p.join(" and ") : p.join(", "), t.report("The property " + d + " is compatible with " + v + " and should be included as well.", c.actualNodes[0].line, c.actualNodes[0].col, n))
                        }
                })
            }
        }), CSSLint.addRule({
            ...
            init: function(e, t) {
                ...
                e.addListener("startrule", n), e.addListener("startfontface", n), e.addListener("startpage", n), e.addListener("startpagemargin", n), e.addListener("startkeyframerule", n), e.addListener("property", function(e) {
                    var n = e.property,
                        ...
                        l = u.length;
                    if (s[o])
                        while (a < l) u[a].type == "color" && ("alpha" in u[a] || "hue" in u[a] ? (/([^\)]+)\(/.test(u[a]) && (f = RegExp.$1.toUpperCase()), (!i || i.property.text.toLowerCase() != o || i.colorType != "compat") && t.report("Fallback " + o + " (hex or RGB) should precede " + f + " " + o + ".", e.line, e.col, r)) : e.colorType = "compat"), a++;
                    i = e
                })
            }
        }), CSSLint.addRule({
            ...
            init: function(e, t) {
                ...
                for (s in l)
                    if (l.hasOwnProperty(s))
                        for (o = 0, u = l[s].length; o < u; o++) a[l[s][o]] = s;
            ...
            init: function(e, t) {
                ...
                e.addListener("startrule", function(r) {
                    ...
                    for (a = 0; a < i.length; a++) {
                        s = i[a], o = s.parts[s.parts.length - 1];
                        if (o.type == e.SELECTOR_PART_TYPE)
                            for (l = 0; l < o.modifiers.length; l++) u = o.modifiers[l], u.type == "attribute" && (!o.elementName || o.elementName == "*") && t.report(n.desc, o.line, o.col, n)
                    }
                })
            }
        }), CSSLint.addRule({
